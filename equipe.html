...
<head>
  ...
  <div class="container" id="tudo"> 
    ...
    <div class ="row">
        <div class="col-sm-12">
                <h2 >Equipe</h2>
                        <p>Funcionários do Laboratório de Ferrovias e Asfalto</p>
        </div>
     ...
     <div class = "row">
        <div class = "container">
            <div class="col-sm-3">
                <a href="#fig1" data-toggle="collapse">
                <img src="images/bandmember.jpg" class="img-circle equipe" alt="Random Name">
                </a>
                <div id="fig1" class ="collapse">
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                </div>
            </div>
            <div class="col-sm-3">
                <a href="#fig2" data-toggle="collapse">
                <img src="images/bandmember.jpg" class="img-circle equipe" alt="Random Name">
                </a>
                <div id="fig2" class ="collapse">
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                </div>
            ...
            <div class="col-sm-3">
                <a href="#fig3" data-toggle="collapse">
                <img src="images/bandmember.jpg" class="img-circle equipe" alt="Random Name">
                </a>
                <div id="fig3" class ="collapse">
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                </div>
            ...
            <div class="col-sm-3">
                <a href="#fig4" data-toggle="collapse">
                <img src="images/bandmember.jpg" class="img-circle equipe" alt="Random Name">
                </a>
                <div id="fig4" class ="collapse">
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                </div>
           ...
           <div class="col-sm-3">
                <a href="#fig5" data-toggle="collapse">
                <img src="images/bandmember.jpg" class="img-circle equipe" alt="Random Name">
                </a>
                <div id="fig5" class ="collapse">
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                </div>
            ...
            <div class="col-sm-3">
                <a href="#fig6" data-toggle="collapse">
                <img src="images/bandmember.jpg" class="img-circle equipe" alt="Random Name">
                </a>
                <div id="fig6" class ="collapse">
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                </div>
            ...
            <div class="col-sm-3">
                <a href="#fig7" data-toggle="collapse">
                <img src="images/bandmember.jpg" class="img-circle equipe" alt="Random Name">
                </a>
                <div id="fig7" class ="collapse">
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                </div>
            ...
            <div class="col-sm-3">
                <a href="#fig8" data-toggle="collapse">
                <img src="images/bandmember.jpg" class="img-circle equipe" alt="Random Name">
                </a>
                <div id="fig8" class ="collapse">
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                    <p>Testando bla bla bla</p>
                </div>
...
<div class="footer">
      <div class="container"><!--essa classe ocupa 12 colunas-->
